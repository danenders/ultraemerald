...
static const u8 sCostumeBackPics[COSTUME_COUNT][GENDER_COUNT] = 
{
    ...
    [COSTUME_1]       = {TRAINER_BACK_PIC_RUBY_SAPPHIRE_BRENDAN, TRAINER_BACK_PIC_RUBY_SAPPHIRE_BRENDAN},
    [COSTUME_2]       = {TRAINER_BACK_PIC_RUBY_SAPPHIRE_MAY, TRAINER_BACK_PIC_RUBY_SAPPHIRE_MAY},
    [COSTUME_3]       = {TRAINER_BACK_PIC_MAY, TRAINER_BACK_PIC_MAY},
};
