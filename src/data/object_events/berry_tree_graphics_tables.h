...
[ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    ...
    [ITEM_YACHE_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    [ITEM_CHOPLE_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Aspear,
    [ITEM_KEBIA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Cheri,
    [ITEM_SHUCA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Hondew,
    [ITEM_COBA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Rawst,
    [ITEM_PAYAPA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Hondew,
    [ITEM_TANGA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Aspear,
    [ITEM_CHARTI_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Lansat,
    [ITEM_KASIB_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Aspear,
    [ITEM_HABAN_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Leppa,
    [ITEM_COLBUR_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Hondew,
    [ITEM_BABIRI_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Liechi,
    [ITEM_ROSELI_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Hondew,
    ...
    [ITEM_CUSTAP_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Hondew,
    [ITEM_JABOCA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Hondew,
    [ITEM_ROWAP_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Hondew,
