...
static void Mugshots_CreateTrainerPics(struct Task *task)
{
    ...
    task->tPlayerSpriteId = CreateTrainerSprite(GetTrainerFrontSpriteBasedOnPlayerCostumeAndGender(gSaveBlock2Ptr->costumeId, gSaveBlock2Ptr->playerGender), DISPLAY_WIDTH + 32, 106, 0, gDecompressionBuffer); //GENDERFIX
